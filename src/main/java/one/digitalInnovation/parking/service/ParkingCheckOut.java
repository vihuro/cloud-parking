...
public class ParkingCheckOut {
    ...
    public static final int TWENTY_FOR_HOUR   = 24 + ONE_HOUR;
    ...
    public static Double getBill(ParkignModel model){
        return getBill(model.getEntryDate(),model.getExitDate());
    ...
    private static Double getBill(LocalDateTime entryDate, LocalDateTime exitDate) {
        ...
        int days = (int) (minutes / TWENTY_FOR_HOUR);
